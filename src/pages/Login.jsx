...
export default function Login() {
  const { login, socialLogin, showToast } = useAuth();
  ...
  // Set document title
  React.useEffect(() => {
    document.title = "Patient Account Login | DocAppoint";
  }, []);
    ...
    <div className="auth-page-wrapper container">
      <div className="glass-panel auth-card">
        <div className="auth-header-card">
          ...
          <p className="auth-subtitle">Access your personal clinical dashboard and appointments.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button 
            ...
            onClick={() => showToast('Forgot password flow is disabled for examiner convenience.', 'info')}
          >
            Forgot Password?
          </button>
        ...
        <div className="social-login-divider">or authenticate with</div>
